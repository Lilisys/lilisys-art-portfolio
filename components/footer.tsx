      ...
      <div className="mb-32 flex text-center lg:mb-0 lg:grid-cols-4 lg:text-left bg-wisteria">
        ...
        >
          ...
          >
            ...
            <a 
              className="inline-block hover:underline transition-transform hover:translate-x-1 motion-reduce:transform-none" 
        ...
        >
          ...
          <div className={'m-0 max-w-[30ch] text-m'}>
            {/* todo: loop to generate these */}
            <a 
              className="inline-block hover:underline transition-transform hover:translate-x-1 motion-reduce:transform-none"
